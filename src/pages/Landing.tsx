        ...
        <section id="home">
          ...
          >
            ...
            <div className="mt-8 flex gap-4 justify-center">
              <Link
                to="/login"
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white rounded-xl font-medium shadow-lg transition-all"
              >
                Sign In
              </Link>
              <Link
                to="/signup"
                className="px-6 py-3 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-900 dark:text-white rounded-xl font-medium border border-gray-300 dark:border-gray-600 transition-all"
              >
                Create Account
              </Link>
            </div>
